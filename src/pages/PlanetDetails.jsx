...
const PlanetDetails = () => {
    ...
    const rawPlanet = store.planets[id - 1];
    ...
    const planetObj = {
     ...
     orbitalPeriod: rawPlanet['orbital_period'], 
        ...
        {activeTab === 'overview' && (
         <div className='tab-pane active' role='tabpanel'>
           <p className='text-white-50 text-center'>
            El planeta {planetObj.name} es conocido por sus características de {planetObj.terrain}. Su atmósfera de {planetObj.climate} sostiene una población de {planetObj.population} y está sujeta a una gravedad de {planetObj.gravity}.
           </p>
         </div>
        )}
